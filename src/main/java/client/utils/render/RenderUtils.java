...
public final class RenderUtils {
	...
	public static Vec3 renderEntityPos(Entity e) {
		double x = e.lastTickPosX + (e.posX - e.lastTickPosX) * TimerUtils.getTimer().renderPartialTicks -
				mc.getRenderManager().viewerPosX;
		double y = e.lastTickPosY + (e.posY - e.lastTickPosY) * TimerUtils.getTimer().renderPartialTicks -
				mc.getRenderManager().viewerPosY;
		double z = e.lastTickPosZ + (e.posZ - e.lastTickPosZ) *TimerUtils.getTimer().renderPartialTicks -
				mc.getRenderManager().viewerPosZ;
		return new Vec3(x, y, z);
	}

	public static void drawCircle(Vec3 pos, double range, int quality, Color color) {
	...
	public static void drawString(FontRenderer fontRendererIn, String str, Vec3 pos, Color color, double scale) {
		double x=pos.xCoord;
		double y=pos.yCoord;
		double z=pos.zCoord;
	...
	public static void drawString(FontRenderer fontRendererIn, String str, Vec3 pos, Color color) {
		double x=pos.xCoord;
		double y=pos.yCoord;
		double z=pos.zCoord;
	...
	public static void drawEntityBox(Entity entity, Color color) {
		...
		double aabbX = entity.getEntityBoundingBox().maxX-entity.getEntityBoundingBox().minX;
		double aabbY = entity.getEntityBoundingBox().maxY-entity.getEntityBoundingBox().minY;
		double aabbZ = entity.getEntityBoundingBox().maxZ-entity.getEntityBoundingBox().minZ;
