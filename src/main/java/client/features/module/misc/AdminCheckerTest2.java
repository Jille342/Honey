...
public class AdminCheckerTest2 extends Module
{
    ...
    public AdminCheckerTest2() {
        super("AdminCheckerTest2", 0, Category.MISC);
    ...
    public void onEvent(Event<?> e) {
        if (e instanceof EventRender2D && this.noticeMode.getMode().equals("Display")) {
            ...
            if (!this.checkedAdmins.isEmpty()) {
                ...
                this.font.drawStringWithShadow("Admin INC " + this.checkedAdmins + " " + this.checkedAdmins.size(), 3.0 / scale, 50 / scale, this.color);
                ...
                this.font.drawStringWithShadow("No Admins" + this.checkedAdmins + " " + this.checkedAdmins.size(), 3.0 / scale, 50/ scale, this.color);
                GlStateManager.popMatrix();
            }
        }
