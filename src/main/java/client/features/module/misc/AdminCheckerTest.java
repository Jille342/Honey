...
public class AdminCheckerTest extends Module
{
    ...
    public void onEvent(Event<?> e) {
        if (e instanceof EventRender2D && this.noticeMode.getMode().equals("Display")) {
            ...
            if (!this.checkedAdmins.isEmpty()) {
                ...
                this.font.drawStringWithShadow("Admin INC " + this.checkedAdmins + " " + this.checkedAdmins.size(), 3.0 / scale, 30.0 / scale, this.color);
                ...
                this.font.drawStringWithShadow("No Admins" + this.checkedAdmins + " " + this.checkedAdmins.size(), 3.0 / scale, 30.0 / scale, this.color);
                GlStateManager.popMatrix();
            }
        }
    ...
    public String[] getAdministrators() {
        return new String[] { "Axyy", "Mistri", "Galap", "Hilevi", "Sevy13", "Carrots386", "DJ_Pedro", "FullAdmin", "ImbC", "JTGangsterLP6", "M4bi", "Outra", "SnowVi1liers", "lPirlo", "ImAbbyy", "Brxnton", "Jarool", "LangScott", "pigplayer" };
    }
