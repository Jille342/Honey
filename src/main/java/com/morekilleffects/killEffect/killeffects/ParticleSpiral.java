...
public class ParticleSpiral {
    ...
    public ParticleSpiral(double x, double y, double z) {
        this.x = x;
        this.yStart = y;
        this.z = z;
    }
    ...
    private void createParticleAtOffset(double rad) {
        ...
        // 紫の煙
        mc.theWorld.spawnParticle(EnumParticleTypes.REDSTONE, particlePos.xCoord, particlePos.yCoord, particlePos.zCoord, 255, 0, 255);
        mc.theWorld.spawnParticle(EnumParticleTypes.REDSTONE, particlePos7.xCoord, particlePos1.yCoord + 1, particlePos7.zCoord, 255, 0, 255);
        mc.theWorld.spawnParticle(EnumParticleTypes.REDSTONE, particlePos1.xCoord, particlePos1.yCoord + 2, particlePos1.zCoord, 255, 0, 255);
        mc.theWorld.spawnParticle(EnumParticleTypes.REDSTONE, particlePos2.xCoord, particlePos2.yCoord + 3, particlePos2.zCoord, 255, 0, 255);
        mc.theWorld.spawnParticle(EnumParticleTypes.REDSTONE, particlePos3.xCoord, particlePos3.yCoord + 4, particlePos3.zCoord, 255, 0, 255);
        mc.theWorld.spawnParticle(EnumParticleTypes.REDSTONE, particlePos4.xCoord, particlePos4.yCoord + 5, particlePos4.zCoord, 255, 0, 255);
        mc.theWorld.spawnParticle(EnumParticleTypes.REDSTONE, particlePos5.xCoord, particlePos5.yCoord + 6, particlePos5.zCoord, 255, 0, 255);
